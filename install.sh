...
# Create empty mab_users file initially
cat > /etc/freeradius/3.0/mab_users << 'MABUSEREOF'
...
# Create empty files module initially
mkdir -p /etc/freeradius/3.0/mods-enabled
...
chmod -R 755 /var/lib/freeradius /var/run/freeradius /var/log/freeradius 2>/dev/null || true
